"""
Simple working smart contract - No variable assignments
"""
...
def approval_program():
    ...
    def lose():
        return Seq([
            ...
            # Calculate commission (5% of stake)
...
if __name__ == "__main__":
    print("🚀 Running Simple Smart Contract...")
    ...
    try:
        ...
        # Write TEAL files
        with open("artifacts/simple_approval.teal", "w") as f:
            f.write(approval_teal)
        
        with open("artifacts/simple_clear.teal", "w") as f:
            f.write(clear_teal)
        
        print("✅ Smart contract compiled successfully!")
        print("📁 Files created:")
        print("   - artifacts/simple_approval.teal")
        print("   - artifacts/simple_clear.teal")
